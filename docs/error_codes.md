# OKX REST API Error Codes

Source: https://www.okx.com/docs-v5/en/#error-code-rest-api
Fetched on: 2026-05-04

This file is generated from OKX v5 REST API docs for phase-1 review. The first SDK implementation should map only the v1 order-placement and reconciliation surface, not every OKX product area.

## v1 mapping priorities

| Code pattern | SDK exception | Reason |
|---|---|---|
| 50001, 50004 | NetworkError | retryable service/endpoint timeout; place-order path must reconcile |
| 50011, 50061 | RateLimitError | rate limit response |
| 50101-50114 | AuthenticationError | API key, timestamp, signature, passphrase, or environment mismatch |
| 51000-51003 | InvalidOrderError | invalid or missing order parameters |
| 51004_* | PositionError | leverage/position limit constraints |
| 51008 and 51008_* | InsufficientFundsError | balance or margin constraints |
| 51020 | InvalidOrderError | order size below minimum |
| 51120 | InsufficientFundsError | insufficient margin |
| 51400, 51603 | OrderNotFoundError | order does not exist during query/cancel/reconciliation |
| inactive/unavailable/system busy codes | ExchangeMaintenanceError or NetworkError | depends on retryability in phase-2 tests |
